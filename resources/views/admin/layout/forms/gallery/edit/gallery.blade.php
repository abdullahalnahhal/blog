<form action="{{route('cp.gallery.update',['image' => $image->id])}}" method="post" accept-charset="utf-8" autocomplete="off" enctype='multipart/form-data'>
    @csrf
    @method('PUT')
    <div class="row clearfix">
        <div class="col-sm-6">
            <div class="form-group form-float ">
              ...
              <input type="text" name='title' class="form-control" required aria-required="true" maxlength='200' value='{{old('title')??$image->title}}'>
            </div>
        </div>
        <div class='col-sm-6'>
          <div class="form-group form-float">
        ...
        <div class="col-12">
          <div class="form-group form-float ">
            ...
            <textarea id="maxlength-textarea" name='description' class="form-control" maxlength="300" rows="3" placeholder="@lang('gallery.Gallery Content has a limit of 500 chars.')">{{old('content')??$image->description}}</textarea>
          </div>
        </div>
    </div>
    <br>
